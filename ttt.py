...
while True:
  printBoard(T)
  avaliable=['0','1','2','3','4','5','6','7','8']


  moveX = input("X move?")
  if moveX not in avaliable:
    moveX = input("Position is occupied or invalid value. X move?")
  else:
    T[int(moveX)] = 1
    avaliable.remove(moveX)
  ...
  if genNonLoser(T,player)!=-1:
    T[genNonLoser(T,player)]=2
  elif genWinningMove(T,player)!=-1:
